...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @package extMKDocs                     @brief [ PACKAGE   ] - MkDocs.
## @dir     extMKDocs/python              @brief [ DIRECTORY ] - Python path.
## @dir     extMKDocs/python/extMKDocs    @brief [ DIRECTORY ] - Python package.
## @file    extMKDocs/packageInfoLib.py   @brief [ FILE      ] - Package info module.
## @package extMKDocs.packageInfoLib      @brief [ MODULE    ] - Package info module.
